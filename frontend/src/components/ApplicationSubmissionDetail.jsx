...
export default function ApplicationSubmissionDetail() {
  ...
  const activateProfile = () => {
    ...
    try {
      localStorage.setItem('lastApplicationId', String(application.id));
      if (application?.status) localStorage.setItem('lastApplicationStatus', String(application.status));
